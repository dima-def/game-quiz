...
num = input('Нажмите 1 если ходите вывести имя владельца или добавить другого, 2 если марку, 3 если цвет, 4 если лошадиные силы, 5 если гос. номер. 6 если просто посмотреть характеристику')
